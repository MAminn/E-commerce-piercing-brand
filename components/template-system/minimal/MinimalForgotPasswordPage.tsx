          ...
          {isSuccess ? (
            ...
            <>
              ...
              <div className='text-center mb-8'>
                ...
                <p className='text-sm text-perce-ink-muted'>{t("forgot.subtitle")}</p>
              </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className='flex flex-col gap-6'>
                ...
                aria-describedby='forgot-email-error'
                  ...
                  {form.formState.errors.email && (
                    <p id='forgot-email-error' role='alert' className='text-perce-sale text-xs mt-2'>
                ...
                <Link
                  href='/login'
                  className='inline-flex items-center justify-center gap-2 text-sm text-perce-ink hover:text-perce-ink-secondary transition-colors mt-2'>
                  <ArrowLeft className='w-4 h-4' />
                  {t("forgot.back_to_login")}
                </Link>
              </form>
