  ...
  return (
    <section className='min-h-screen flex items-center justify-center bg-perce-surface-raised px-4 py-12'>
      <div className='w-full max-w-[480px]'>
        {/* Card */}
        <div className='border border-perce-line bg-perce-surface-raised p-8 sm:p-12'>
          {isRegistered ? (
            /* Success state */
            <div className='flex flex-col items-center gap-5 text-center py-6'>
              <div className='w-14 h-14 rounded-full bg-green-50 flex items-center justify-center'>
                <CheckCircle className='w-7 h-7 text-perce-success' />
              </div>
              <div className='space-y-2'>
                <h1 className='text-xl sm:text-2xl font-medium text-perce-ink tracking-tight'>
                  {t("register.success_title")}
                </h1>
                <p className='text-sm text-perce-ink-muted leading-relaxed max-w-xs mx-auto'>
                  {t("register.success_message")}
                </p>
              </div>
              <Link
                href='/login'
                className='inline-flex items-center gap-2 text-sm text-perce-ink hover:text-perce-ink-secondary transition-colors mt-4'>
            ...
            <>
              ...
              <div className='text-center mb-10'>
                <h1 className='text-2xl sm:text-[28px] font-medium text-perce-ink tracking-tight mb-3'>
                  {t("register.title")}
                </h1>
                <p className='text-sm text-perce-ink-muted'>{t("register.subtitle")}</p>
              </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className='flex flex-col gap-7'>
                ...
                aria-describedby='reg-name-error'
                    ...
                    {form.formState.errors.name && (
                      <p id='reg-name-error' role='alert' className='text-perce-sale text-xs mt-2'>
                ...
                aria-describedby='reg-email-error'
                    ...
                    {form.formState.errors.email && (
                      <p id='reg-email-error' role='alert' className='text-perce-sale text-xs mt-2'>
                ...
                aria-describedby='reg-phone-error'
                  ...
                  {form.formState.errors.phone && (
                    <p id='reg-phone-error' role='alert' className='text-perce-sale text-xs mt-2'>
                ...
                aria-describedby='reg-password-error'
                    ...
                    {form.formState.errors.password && (
                      <p id='reg-password-error' role='alert' className='text-perce-sale text-xs mt-2'>
                ...
                aria-describedby='reg-confirm-error'
                    ...
                    {form.formState.errors.confirmPassword && (
                      <p id='reg-confirm-error' role='alert' className='text-perce-sale text-xs mt-2'>
                ...
                <div className='flex items-center gap-3 mt-2'>
                  ...
                  <span className='text-xs text-perce-ink-subtle'>{t("register.has_account")}</span>
                  <div className='h-px flex-1 bg-perce-line' />
                </div>
